...
namespace VenueManagement.Blazor.Menus;

public class VenueManagementMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public VenueManagementMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<VenueManagementResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                VenueManagementMenus.Home,
                l["Menu:Home"],
                "/",
                icon: "fas fa-home",
                order: 0
